...
Route::get('userRegister', function () {
	return view('userdashboardRegister');

});
Route::post('updateCollectedBy','StudioController@updateCollectedBy');
Route::post('getstate','StudioregisterController@getstate');
...
Route::get('admin/dashboard_table', 'AdminController@dashboard_table')->name('dashboard_table'); //studio table
...
//---------------view distributer, deleteand update--------------------------//
Route::get('admin/distributer', 'AdminController@Distributer')->name('Distributer');
Route::get('admin/dailycode', 'AdminController@dailycode')->name('dailycode');
Route::post('admin/editdailycode', 'AdminController@editdailycode')->name('editdailycode');
Route::get('admin/distributer/delete={id}', 'AdminController@deleteDistributer')->name('deleteDistributer');
Route::post('admin/updatedistributor', 'AdminController@updateDistributer')->name('updateDistributer');
Route::post('admin/adddistributer', 'AdminController@insertDistributer')->name('insertDistributer');
Route::post('admin/addemployee', 'AdminController@addemployee')->name('addemployee');
Route::get('/detail_search', 'AdminController@detail_search')->name('detail'); 
Route::post('/selectstate','AdminController@selectstate');
Route::post('/selectdetail','AdminController@selectdetail');
Route::post('/distributordetail','AdminController@distributordetail');
Route::post('/selecttype','AdminController@selecttype');
Route::post('/PaymentStatus','AdminController@PaymentStatus');