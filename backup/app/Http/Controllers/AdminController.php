...
// print_r($id); die;
 ...
 // print_r($request); die;
      ...
      public function Distributer(){
            $distributer = distributormodel::get();
            return view('admin.distributer_table',['distributer'=>$distributer]);
      }

      public function deleteDistributer($id){
           $dist = distributormodel::where('distributer_id',$id)->delete();
           if($dist){
      ...
      public function updateDistributer(Request $request){
            ...
            $data=['name'=>$name];
            $update_dis = distributormodel::where('distributer_id',$id)->update($data);
            if($update_dis){
