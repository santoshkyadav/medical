                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/registerStudio') }}">
                        ...
                        <div class="form-group{{ $errors->has('distributer') ? ' has-error' : '' }}">
                            <label for="distributer" class="col-md-4 control-label">Select Distributer</label>
                                @php
                                    $dist = DB::table('distributer')->get()->toArray();
                                @endphp
                            <div class="col-md-6">
                                <select class="form-control" name="distributer" >
                                    
                                    <option value="">Select distributer</option>
                                    @foreach($dist as $dist_val)
                                        <option value="{{$dist_val->distributer_id}}">{{$dist_val->Name}}</option>
                                    @endforeach   
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('software') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="50software" type="checkbox" name="software" value="50book"> <b>50 EBook</b>
                                <input id="100software" type="checkbox" name="software" value="100book"> <b>100 EBook</b>
                        ...
                        <div class="form-group{{ $errors->has('collectedby') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="collectedby" type="text" class="form-control" name="collectedby">
