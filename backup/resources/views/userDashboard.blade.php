				...
				<div class="four-grids">
					...
					<div class="col-md-3 four-grid">
						...
						@endphp
							...
							<a href="{{url('user_dashboard/templatesummary/template/TEMPLATE')}}">More Info</a>
						</div>
					</div>
					<div class="col-md-3 four-grid">
						<div class="four-grid4">
							...
							<a href="{{url('user_dashboard/templatesummary/template/MASK')}}">More Info</a>
						</div>
					</div>
					<div class="col-md-3 four-grid">
						<div class="four-grid1">
							...
							<a href="{{url('user_dashboard/templatesummary/template/BACKGROUND')}}">More Info</a>
						</div>
					</div>
					<div class="col-md-3 four-grid">
						<div class="four-grid1">
							...
							<a href="{{url('user_dashboard/templatesummary/template/FRAMES')}}">More Info</a>
						</div>
					</div>
					<div class="clearfix"></div>
				</div>
