<div id="wrapper" >
    ...
    @if(!empty($customer_details))
            ...
            <button type="submit" data-id="{{$customer_details->id}}" class="function_data btn btn-success">Update</button>
     @endif
                ...
                <ul>
                    ...
                    <li class="nav-item user_nev event-names">
                        <a href="#" class="nav-link event_Photos" title="View Photos" data-name="{{$photocount->FolderName}}"> 
                            <img src="{{url('assets/image/Toma4025-Rumax-Folder.ico')}}" style="width: 60px;height:100px;"><span class="sidebar_menu" style="padding-left: 10px;">{{ucfirst($photocount->FolderName)}}</span><span class="count_pics">{{$photocount->NoofPhoto}}</span> 
                        </a>
                    ...
                    <li class="nav-item user_nev event-names">
                        <a href="#" class="nav-link event_Photos" title="View Photos" data-name="{{$photocount->FolderName}}"> 
                            <img src="{{url('assets/image/Toma4025-Rumax-Folder.ico')}}" style="width: 60px;height:100px;"><span class="sidebar_menu" style="padding-left: 10px;">{{ucfirst($photocount->FolderName)}}</span><span class="count_pics">{{$photocount->NoofPhoto}}</span>
                            <!--<span class="count_pics">{{$photocount->SelectedPhoto.'/'.$photocount->NoofPhoto}}</span> -->
                        </a>
                    </li>
                    @endif
                    @endforeach
