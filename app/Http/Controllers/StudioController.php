...
class StudioController extends Controller {
    ...
    public function updateCollectedBy(Request $req){
      $paymentmodel=new PaymentdetailModel();
      $id=$req->id;
      //echo $id;
      $AmountPaidFor=$req->software;
        //$AmountPaidFor=$req->other;
      if($AmountPaidFor=='50book' || $AmountPaidFor=='100book'){
          $CollectionPlace=$req->distributer;
          ...
          $data=['CollectionPlace' =>$CollectionPlace,'CollectedBy' =>$CollectedBy,'Remark' =>$Remark,'AmountPaid' =>$AmountPaid,'AmountPaidFor' =>$AmountPaidFor];
            DB::table('payment')->where('Payment_Id','=',$id)->update($data);
